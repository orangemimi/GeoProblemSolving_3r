  ...
  <div>
    <Row>
      <Menu
        ...
        theme="dark"
      >
        <MenuItem name="back" class="menuItem" title="Project page">
        ...
        <MenuItem name="info" class="menuItem" title="Subproject introduction">
          <Icon type="ios-information-circle" size="30" />
        </MenuItem>
        <MenuItem name="task" class="menuItem" title="Task arrangement">
          <Icon type="md-calendar" size="30" />
        </MenuItem>

        <MenuItem name="process" class="menuItem" title="Working steps">
          <!-- <Icon type="md-git-branch" size="30" /> -->
          <Icon type="md-analytics" size="30" />
        </MenuItem>

        <MenuItem name="resource" class="menuItem" title="Resources">
